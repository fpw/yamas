...
import { decodeDECFloat } from "../../../src/utils/float/DECFloat.js";
...
describe("GIVEN a program with FLTG statements", () => {
    describe("WHEN evaluating FLTG statements", () => {
        ...
        test("THEN they should generate 12 bit exponents and 24 bit mantissas", () => {
            ...
            expect(decodeDECFloat(0o0003, 0o2427, 0o6677)).toBeCloseTo(509.32e-02, 6);

            expect(data.memory[0o403]).equals(0o0024);
            expect(data.memory[0o404]).equals(0o5462);
            expect(data.memory[0o405]).equals(0o0740);
            expect(decodeDECFloat(0o0024, 0o5462, 0o0740)).toBeCloseTo(-62.97E04, 6);
